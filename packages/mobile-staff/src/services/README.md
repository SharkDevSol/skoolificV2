...
This directory contains reusable service classes for the Skoolific Staff Mobile App.
...
1. Create a new file with a descriptive name (e.g., `NotificationService.js`)
