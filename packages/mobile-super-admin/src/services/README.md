...
This directory contains reusable service classes for the Skoolific Super Admin Mobile App.
...
1. Create a new file with a descriptive name (e.g., `AggregationService.js`)
